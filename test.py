...
# path = 'E:/ftp/admin/192.168.81.13/192.168.81.13_01_20190506162627599_FACE_BACKGROUND.jpg'
# os.path.basename()
# print(os.path.basename(os.path.dirname(path)))
# print(path.lstrip(file_path))
# param = path.lstrip(file_path)
# path_list = param.split('/')
# print(path_list[0])

# dirname = path.lstrip(file_path).split('/')[0]
# print(dirname)
with open('E:\\ftp\\admin\\192.168.81.13\\192.168.81.13_201905061028299686_face.jpg', 'b') as f:
    data = f.read()
